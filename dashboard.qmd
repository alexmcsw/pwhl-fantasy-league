...
value_box(
    ...
    p(
        paste0(
            next_game_day[1,"home_team_code"],
            " @ ",
            next_game_day[1,"away_team_code"],
            ", ",
            next_game_day[1,"time"]
        )
    ),
    p(
        paste0(
            next_game_day[2,"home_team_code"],
            " @ ",
            next_game_day[2,"away_team_code"],
            ", ",
            next_game_day[2,"time"]
        )
    )
